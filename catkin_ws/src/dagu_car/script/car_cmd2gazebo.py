...
class CarCmd2GazeboNode(object):
    def __init__(self):
	...
	'''
        ...
        self.pub_gazebo_car_cmd = rospy.Publisher("cmd_vel", Twist, queue_size=1)
	...
	'''
	msg_gazebo_car_cmd = Twist()
	msg_gazebo_car_cmd.linear.x = msg_car_cmd.v
	msg_gazebo_car_cmd.angular.z =msg_car_cmd.omega/2    #---/3
	self.pub_gazebo_car_cmd.publish(msg_gazebo_car_cmd)
...
if __name__ == '__main__':
    rospy.init_node('car_cmd2gazebo_node', anonymous=False)
    car_cmd2gazebo_node = CarCmd2GazeboNode()
    rospy.spin()
